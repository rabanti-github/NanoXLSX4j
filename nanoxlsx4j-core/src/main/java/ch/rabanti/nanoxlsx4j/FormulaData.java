...
public class FormulaData implements Comparable<FormulaData> {
    ...
    /**
     * Gets the formula expression as string. This value is currently identical with {@link Cell#getValue()} if {@link Cell#getDataType()} is set to {@link Cell.CellType#FORMULA}.
    ...
    void setExpression(String expression) {
        ...
        this.externalReferences = ParserUtils.containsExternalReference(expression);
    }
     ...
     *
     * <p>Remarks: This value can be supplied through the constructor or set when a Workbook is loaded. Formula error results are represented by
     * {@link FormulaError} values. The value is not evaluated when a new formula was defined by
     * {@link Worksheet#addCellFormula(String, int, int)} or its overload methods.
     * </p>
    ...
    /**
     * Gets the data type of {@link FormulaData#getCachedValue()}. The default is {@link Cell.CellType#DEFAULT}
    ...
    /**
     * Internal feature set for cascading feature detection (consider in {@link FormulaData#copy()}  but not in Equals, GetHashCode etc.)
     * @return Feature set
     */
    ...
    /**
     * Constructor with formula expression and optional cached value to create a formula of the common type {@link FormulaType#NORMAL}
     *
     * <p>Remarks: A basic validity checks (not full parsing) will perform on the expression, e.g. existence of an external link in the formula</p>
     *
     ...
     *
     * <p>Remarks: This copy method omits deep-copying {@link FormulaData#getDefinedNameReference()} by design. If a full copy is intended, this instance variable must be handled separately.</p>
     *
    ...
    private static int compareObjects(Object a, Object b) {
        ...
        throw new ClassCastException(
                "Objects are not comparable: " + a.getClass().getName());
    }
}
