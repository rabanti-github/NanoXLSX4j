...
public record Range(Address startAddress, Address endAddress) {
    ...
    /**
     * Constructor with addresses as arguments. The addresses are automatically swapped if the start address is greater
     * than the end address. Referencing modifiers ($) for rows and columns can be passed through the address type of
     * the address objects
     *
     * @param startAddress start address of the range
     * @param endAddress   end address of the range
    ...
    /**
     * Constructor with start and end rows and columns as arguments. The addresses are automatically swapped if the
     * start address is greater than the end address. Referencing modifiers ($) for rows and columns are not considered
     *
     ...
     * greater than the end address. Referencing modifiers ($) for rows and columns can be defined in the passed string
     *
     ...
     *
     * <p>Remarks: Use this function with caution. Very big ranges may result to hundred of Millions or even Billions of
     * cells. This may lead to an extremely high memory consumptions or even a crash of the application</p>
     *
