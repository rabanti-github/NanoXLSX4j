...
public class Workbook {
    ...
    /**
     * Gets the password instance used for workbook protection
     *
     * @return Password instance containing the plain text and hash
     ...
     */
    public IPassword getWorkbookProtectionPassword() {
        return workbookProtectionPassword;
    }

    /**
     * Sets the password instance for workbook protection
     *
     * @param workbookProtectionPassword Password instance
     ...
     */
    void setWorkbookProtectionPassword(IPassword workbookProtectionPassword) {
        this.workbookProtectionPassword = workbookProtectionPassword;
    }

    /**
     * Gets the theme of the workbook
     *
    ...
    /**
     * Sets the theme of the workbook
     *
     * @param workbookTheme Workbook theme. Can be null to clear the theme
     */
    ...
    /**
     * Gets the auxiliary data of the workbook (used by plug-ins)
     *
     * @return Auxiliary data object
     */
    ...
    public void addMruColor(String color) {
        ...
        mruColors.add(Color.createRgb(color.toUpperCase()));
    }

    /**
     * Adds a color instance to the MRU list
     *
     ...
     *
     * @return Copy of the MRU color list
     */
    ...
    public void removeStyle(String styleName, boolean onlyIfUnused) {
        if (ParserUtils.isNullOrEmpty(styleName)) {
    ...
    public Worksheet setCurrentWorksheet(String name) {
        ...
        WS.setCurrentWorksheetInternal(currentWorksheet);
        return currentWorksheet;
    }
    ...
    public void setSelectedWorksheet(String name) {
        Worksheet found = worksheets.stream().filter(w -> w.getSheetName().equals(name)).findFirst().orElse(null);
        if (found == null) {
            throw new WorksheetException("No worksheet with the name '" + name + "' was found in this workbook.");
        }
        this.selectedWorksheet = worksheets.indexOf(found);
    }
    ...
    public void setWorkbookProtection(boolean state, boolean protectWindows, boolean protectStructure, String password) {
        ...
        this.workbookProtectionPassword.setPassword(password);
        this.workbookProtectionPassword.setPasswordHash(DataUtils.generatePasswordHash(password));
    ...
    private void init() {
        ...
        this.workbookProtectionPassword = new LegacyPassword(PasswordType.WORKBOOK_PROTECTION);
     ...
     * @throws IOException Throws IOException in case of an error
     */
    public static Workbook load(InputStream stream, ReaderOptions importOptions) throws IOException, java.io.IOException {
