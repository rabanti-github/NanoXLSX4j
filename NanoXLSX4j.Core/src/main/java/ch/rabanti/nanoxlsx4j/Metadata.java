...
public class Metadata {
    ...
    /**
     * Gets the version of the creation application. Default is the library version of PicoXLSjX. Use the format
     * xxxxx.yyyyy (e.g. 1.0 or 55.9875) in case of a custom value.
     *
    ...
    /**
     * Sets the version of the creation application. Default is the library version of PicoXLSX4j. Use the format
     * xxxxx.yyyyy (e.g. 1.0 or 55.9875) in case of a custom value.
     *
     ...
     * @apiNote Allowed values are null, empty and fractions from 0.0 to 99999.99999 (max. number of digits before and
    ...
    /**
     * Gets the category of the document. There are no predefined values or restrictions about the content of this
     * field
     *
    ...
    /**
     * Sets the category of the document. There are no predefined values or restrictions about the content of this
     * field
     *
    ...
    /**
     * Gets the company owning the document. This value is for organizational purpose. Add more than one manager by
     * using the semicolon (;) between the words
     *
    ...
    /**
     * Sets the company owning the document. This value is for organizational purpose. Add more than one manager by
     * using the semicolon (;) between the words
     *
    ...
    /**
     * Checks the format of the passed version string. Allowed values are null, empty and fractions from 0.0 to
     * 99999.99999 (max. number of digits before and after the period is 5)
     *
     * @throws FormatException Thrown if the version string is malformed
     */
    private void checkVersion() {
        if (ParserUtils.isNullOrEmpty(this.applicationVersion)) {
            return;
        }
    ...
    /**
     * Method to parse a common version (major.minor.revision.build) into the compatible format (major.minor). The
     * minimum value is 0.0 and the maximum value is 99999.99999<br> The minor, revision and build number are joined if
     * possible. If the number is too long, the additional characters will be removed from the right side down to five
     * characters (e.g. 785563 will be 78556)
     *
