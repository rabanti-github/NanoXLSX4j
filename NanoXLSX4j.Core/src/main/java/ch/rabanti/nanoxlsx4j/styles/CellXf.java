...
public class CellXf extends AbstractStyle {
    ...
    /**
     * Gets whether the locked property (used for locking / protection of cells or worksheets) will be defined in the XF
     * entry of the style. If true, locked will be defined
     *
    ...
    /**
     * Sets whether the locked property (used for locking / protection of cells or worksheets) will be defined in the XF
     * entry of the style. If true, locked will be defined
     *
    ...
    /**
     * Gets whether the hidden property (used for protection or hiding of cells) will be defined in the XF entry of the
     * style. If true, hidden will be defined
     *
    ...
    /**
     * Sets whether the hidden property (used for protection or hiding of cells) will be defined in the XF entry of the
     * style. If true, hidden will be defined
     *
    ...
    /**
     * Gets whether the applyAlignment property (used to merge cells) will be defined in the XF entry of the style. If
     * true, applyAlignment will be defined
     *
    ...
    /**
     * Sets whether the applyAlignment property (used to merge cells) will be defined in the XF entry of the style. If
     * true, applyAlignment will be defined
     *
     * @param forceApplyAlignment If true, the applyAlignment value of the style will be set to true (used to merge
     *                            cells)
     */
    ...
    /**
     * Method to calculate the internal text rotation. The text direction and rotation are handled internally by the
     * text rotation value
     *
    ...
    /**
     * Converts a HorizontalAlignValue enum to its OOXML string representation
     *
     * @param align Enum value to convert
     * @return OOXML string or empty string for none
     */
    public static String getHorizontalAlignName(HorizontalAlignValue align) {
        switch (align) {
            ...
            case centerContinuous: return "centerContinuous";
    ...
    /**
     * Converts an OOXML string to its corresponding HorizontalAlignValue enum
     *
     * @param name OOXML string value
     * @return Corresponding enum, or {@link HorizontalAlignValue#none} if not found
     */
    public static HorizontalAlignValue getHorizontalAlignEnum(String name) {
        if (name == null) return HorizontalAlignValue.none;
        switch (name) {
            ...
            default: return HorizontalAlignValue.none;
        }
    }

    /**
     * Converts a VerticalAlignValue enum to its OOXML string representation
     *
     * @param align Enum value to convert
     * @return OOXML string or empty string for none
     */
    public static String getVerticalAlignName(VerticalAlignValue align) {
        switch (align) {
    ...
    /**
     * Converts an OOXML string to its corresponding VerticalAlignValue enum
     *
     * @param name OOXML string value
     * @return Corresponding enum, or {@link VerticalAlignValue#none} if not found
     */
    public static VerticalAlignValue getVerticalAlignEnum(String name) {
        if (name == null) return VerticalAlignValue.none;
        switch (name) {
            ...
            default: return VerticalAlignValue.none;
        }
    }
