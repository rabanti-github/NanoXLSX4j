...
public class StyleRepository {
     ...
     *
     * @param importInProgress If true certain exceptions will be suppressed and transformations on styles are performed
     *                         when a worksheet is loaded
     */
     ...
     *
     * @return If true certain exceptions will be suppressed and transformations on styles are performed when a
     * worksheet is loaded
     */
     ...
     * @return Reference from the repository. If the style to add already existed, the existing object is returned,
     * otherwise the newly added one
     */
    public synchronized Style addStyle(Style style) {
        if (style == null) {
            return null;
        }
     ...
     *
     * @apiNote Do not use this maintenance method while writing data on a worksheet or workbook. It will lead to
     * invalid style data or even exceptions.<br> Only use this method after all worksheets in all workbooks are
