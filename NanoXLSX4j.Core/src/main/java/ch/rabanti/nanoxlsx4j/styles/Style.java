...
public class Style extends AbstractStyle {
     ...
     *
     * @param name        Name of the style
     * @param forcedOrder Number of the style for sorting purpose. The style will be placed at this position (internal
     *                    use only)
    ...
    public AbstractStyle copy() {
        ...
        copy.setBorder(this.borderRef.copyBorder());
        copy.setCellXf(this.cellXfRef.copyCellXf());
        copy.setFill(this.fillRef.copyFill());
        copy.setFont(this.fontRef.copyFont());
        copy.setNumberFormat(this.numberFormatRef.copyNumberFormat());
        return copy;
    }
