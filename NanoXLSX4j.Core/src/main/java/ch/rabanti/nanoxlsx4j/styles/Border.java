...
public class Border extends AbstractStyle {
    ...
    /**
     * Parses a border style name and returns the matching enum value
     *
     * @param styleName String to parse
     * @return The corresponding StyleValue enum, or {@link StyleValue#none} if not found
     */
    public static StyleValue getStyleEnum(String styleName) {
        if (styleName == null) return StyleValue.none;
        switch (styleName) {
            ...
            case "double": return StyleValue.s_double;
            default: return StyleValue.none;
        }
    }
    ...
    /**
     * Gets the color code of the left border. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Sets the color code of the left border. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Gets the color code of the right border. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
     * @return Color code (ARGB)
     */
    ...
    /**
     * Sets the color code of the right border. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
    ...
    /**
     * Gets the color code of the top border. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
     * @return Color code (ARGB)
     */
    ...
    /**
     * Sets the color code of the top border. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Gets the color code of the bottom border. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
     * @return Color code (ARGB)
     */
    ...
    /**
     * Sets the color code of the bottom border. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
    ...
    /**
     * Gets the color code of the diagonal lines. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
     * @return Color code (ARGB)
     */
    ...
    /**
     * Sets the color code of the diagonal lines. The value is expressed as hex string with the format AARRGGBB. AA
     * (Alpha) is usually FF
     *
    ...
    /**
     * Method to determine whether the object has no values but the default values (means: is empty and must not be
     * processed)
     *
