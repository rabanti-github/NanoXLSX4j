...
public class AddCellRangeTest {
    ...
    @CsvSource({
            "0,0, OneColumn, RandomList",
            "7, 27, OneRow, RandomList",
            "5, 13, FourColumnsThreeRows, RandomList",
            "22, 11, ThreeColumnsFourRows, RandomList",
            "0,0, OneColumn, CellList",
            "7, 27, OneRow, CellList",
            "5, 13, FourColumnsThreeRows, CellList",
            "22, 11, ThreeColumnsFourRows, CellList",
    })
    ...
    @CsvSource({
            "A1:A12, OneColumn, RandomList",
            "H28:S28, OneRow, RandomList",
            "F14:I16, FourColumnsThreeRows, RandomList",
            "T12:V15, ThreeColumnsFourRows, RandomList",
            "A1:A12, OneColumn, CellList",
            "H28:S28, OneRow, CellList",
            "F14:I16, FourColumnsThreeRows, CellList",
    ...
    @CsvSource({
            "0, 0, OneColumn",
            "7, 27, OneRow",
            "5, 13, FourColumnsThreeRows",
            "22, 11, ThreeColumnsFourRows",
    })
    ...
    @CsvSource({
            "A1:A12, A1:A13, OneColumn",
            "H28:S28,H28:S29, OneRow",
            "F14:I16,F14:J16, FourColumnsThreeRows",
