...
public class NumericCellTest {
    ...
    void byteCellTest(String byteString) {
        genericAssertion(byteUtils, byteString, (byte) 8, Byte.MIN_VALUE, Byte.MAX_VALUE, Byte::parseByte, Byte::equals);
    }
    ...
    void bigDecimalCellTest(String byteString) {
        ...
        genericAssertion(bigDecimalUtils, byteString, BigDecimal.valueOf(8), BigDecimal.valueOf(Integer.MIN_VALUE), BigDecimal.valueOf(Integer.MAX_VALUE), BigDecimal::new, BigDecimal::equals);
    }
    ...
    void doubleCellTest(String doubleString) {
        genericAssertion(doubleUtils, doubleString, 8d, Double.MIN_VALUE, Double.MAX_VALUE, Double::parseDouble, NumericCellTest::compareDouble);
    }
    ...
    void floatCellTest(String floatString) {
        genericAssertion(floatUtils, floatString, 8f, Float.MIN_VALUE, Float.MAX_VALUE, Float::parseFloat, NumericCellTest::compareFloat);
    }
    ...
    void integerCellTest(String integerString) {
        genericAssertion(integerUtils, integerString, 8, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer::parseInt, Objects::equals);
    }
    ...
    void shortCellTest(String shortString) {
        genericAssertion(shortUtils, shortString, (short) 8, Short.MIN_VALUE, Short.MAX_VALUE, Short::parseShort, Objects::equals);
    }
