...
class CellTest {
    ...
    void cellStyleTest() {
        ...
        assertTrue(expectedStyle.equals(cell.getCellStyle())); // Note: assertEquals fails here because of Object reference comparison
    }
    ...
    void removeStyleTest() {
        ...
        assertTrue(style.equals(floatCell.getCellStyle())); // Note: assertEquals fails here because of Object reference comparison
