...
// ### G E T T E R S  &  S E T T E R S ###
     ...
     * @apiNote The password of this property is stored in plan text at runtime but not stored to a workbook. See also {@link #getWorkbookProtectionPassword()} for the generated hash
     */
     ...
     * @apiNote The plain text password cannot be recovered when loading a workbook. The hash is retrieved and can be reused,
     * if no changes are made in the area of workbook protection ({@link #setWorkbookProtection(boolean, boolean, boolean, String)})
     */
     ...
     * @apiNote This method should only be used internally. Please use {@link #setWorkbookProtection(boolean, boolean, boolean, String)} to set a workbook password
     */
...
// ### M E T H O D S ###
     ...
     * @throws WorksheetException Throws a WorksheetExceptionif the worksheet was not found in the worksheet collection
     */
     ...
     * @param sanitizeSheetName If true, the new name will be automatically sanitized if a name collision occurs
     * @return Copied worksheet
     * @apiNote The copy is not set as current worksheet. The existing one is kept. The source worksheet can originate from any workbook
     */
