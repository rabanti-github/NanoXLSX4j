...
/**
 * Writer for the application metadata XML part ({@code docProps/app.xml}).
 * <p>
 * Java equivalent of the .NET internal class
 * {@code NanoXLSX.Internal.Writers.MetadataAppWriter}.
 * </p>
 *
 * <h3>Plugin wiring</h3>
 * <p>
 * This class is a <em>Replacing Plugin</em> registered under
 * {@link PluginUUID#META_DATA_APP_WRITER}.  It is discovered at runtime via
 ...
 * @see PluginUUID#META_DATA_APP_WRITER
 */
@NanoXlsxPlugin(plugInUuid = PluginUUID.META_DATA_APP_WRITER)
public class MetadataAppWriter implements NanoXlsxPluggable, IPluginWriter {

    // ### C O N S T A N T S ###

    private static final String NAMESPACE_PROPERTIES =
            "http://schemas.openxmlformats.org/officeDocument/2006/extended-properties";
    private static final String NAMESPACE_VT =
     ...
     *
     * @return the workbook (typed as {@code Object} during the v3 migration phase)
     */
    @Override
    ...
    /**
     * Builds the application-properties XML content and stores it internally
     * (interface implementation).
     * <p>
     * The generated XML corresponds to the {@code docProps/app.xml} part of
     * an XLSX package.  Constant fields ({@code TotalTime}, {@code DocSecurity},
     * etc.) are always written; metadata-dependent fields are silently omitted
    ...
    public void execute() {
        ...
        appendXmlTag(content, "0",                                           "TotalTime",        null);
        appendXmlTag(content, md != null ? md.getApplication()       : null, "Application",      null);
        appendXmlTag(content, "0",                                           "DocSecurity",       null);
        appendXmlTag(content, "false",                                       "ScaleCrop",         null);
        appendXmlTag(content, md != null ? md.getManager()           : null, "Manager",           null);
        appendXmlTag(content, md != null ? md.getCompany()           : null, "Company",           null);
        appendXmlTag(content, "false",                                       "LinksUpToDate",     null);
        appendXmlTag(content, "false",                                       "SharedDoc",         null);
        appendXmlTag(content, md != null ? md.getHyperlinkBase()     : null, "HyperlinkBase",     null);
        appendXmlTag(content, "false",                                       "HyperlinksChanged", null);
        appendXmlTag(content, md != null ? md.getApplicationVersion(): null, "AppVersion",        null);

        this.xmlString =
                "<Properties" +
                " xmlns=\""     + NAMESPACE_PROPERTIES + "\"" +
                " xmlns:vt=\""  + NAMESPACE_VT         + "\">" +
                content +
                "</Properties>";
     ...
     * </p>
     *
     * @return application-properties XML string, or {@code null} if {@link #execute()} has not been called
     */
    String getXmlString() {
        return xmlString;
    }
