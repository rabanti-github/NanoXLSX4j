...
public class BorderWriteReadTest {
	...
	@CsvSource({ "'FFAACC00', 'STRING', 'test', true, true", "'FFAADD00', 'FLOAT', '0.5f', true, false",
			"'FFDDCC00', 'BOOLEAN', true, false, true", "'FFAACCDD', 'NULL', '', false, false",
			", 'INTEGER', '22', true, true" })
	void diagonalColorTest(String color, String sourceType, String sourceValue, boolean diagonalUp,
	...
	@CsvSource({ "FFAACC00, test", "FFAADD00, 0.5f", "FFDDCC00, true", "FFAACCDD, null", ", null" })
	...
	@CsvSource({ "dashDotDot, Bottom", "dashDot, Top", "dashed, Left", "dotted, Right", "hair, Diagonal",
			"medium, Bottom", "mediumDashDot, Top", "mediumDashDotDot, Left", "mediumDashed, Right",
			"slantDashDot, Diagonal", "thin, Bottom", "s_double, Top", "thick, Left", "none, Right", })
