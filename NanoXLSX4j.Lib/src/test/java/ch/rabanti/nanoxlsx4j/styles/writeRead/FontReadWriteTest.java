...
public class FontReadWriteTest {
	...
	@CsvSource({ "u_single, test", "u_double, 0.5f", "doubleAccounting, true", "singleAccounting, 42", "none, ''", })
	...
	@CsvSource({ "subscript, test", "superscript, 0.5f", "none, true", })
	...
	@CsvSource({ "10.5f, test", "11f, 0.5f", "50.55f, true", })
	...
	@CsvSource({ "1, test", "2, 0.5f", "64, true", })
	...
	@CsvSource({ "minor, test", "major, 0.5f", })
