...
public class CellXfWriteReadTest {
	...
	@CsvSource({ "true, test", "false, 0.5f", })
	...
	@CsvSource({ "false, false, 'test'", "false, true, 0.5f", "true, false, 22", "true, true, true", })
	...
	@CsvSource({ "shrinkToFit, test", "wrapText, 0.5f", "none, true", })
	...
	@CsvSource({ "justify, test", "center, 0.5f", "centerContinuous, true", "distributed, 22", "fill, false",
			"general, ", "left, -2.11f", "right, test", "none,  ", })
	...
	@CsvSource({ "justify, test", "center, 0.5f", "bottom, true", "top, 22", "distributed, false", "none, ' '", })
	...
	@CsvSource({ "0, left, 0, test", "0, right, 0, test", "0, distributed, 0, test", "0, center, 0, test",
			"1, left, 1, 0.5f", "1, right, 1, 0.5f", "1, distributed, 1, 0.5f", "1, center, 0, 0.5f",
			"5, left, 5, true", "5, right, 5, true", "5, distributed, 5, true", "5, center, 0, true",
			"64, left, 64, 22", "64, right, 64, 22", "64, distributed, 64, 22", "64, center, 0, 22", })
	...
	@CsvSource({ "0, test", "1, 0.5f", "-1, true", "45,22", "-45, -0.11f", "90, ", "-90,  ", })
