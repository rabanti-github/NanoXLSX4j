...
public class NumberFormatWriteReadTest {
	...
	@CsvSource({ "164, test", "165, 0.5f", "200, 22", "2000, true", })
	...
	@ParameterizedTest(name = "Given format number {0} with value '{1}' should lead to a cell with the same format number")
	@CsvSource({ "#, test", "'\\', 0.5f", "'\\\\', ''", "' \\.\\ ', false", "' ', 22", "ABCDE, true", })
	...
	@ParameterizedTest(name = "Given format number {0} with value '{1}' should lead to a cell with the same format number")
	@CsvSource({ "format_1, test", "format_2, 0.5f", "format_3, 22", "format_4, true", "format_5, ", "format_6, -1",
			"format_7, -22.222f", "format_8, false", "format_9, 0", "format_10, Æ", "format_11, test",
			"format_12, 0.5f", "format_13, 22", "format_14, true", "format_15, ''", "format_16, -1",
			"format_17, -22.222f", "format_18, false", "format_19, noDate", "format_20, Æ", "format_21, test",
			"format_22, noDate", "format_37, 22", "format_38, true", "format_39, ", "format_40, -1",
			"format_45, -22.222f", "format_46, false", "format_47, noDate", "format_48, Æ", "format_49, test", })
	...
	@CsvSource({ "format_14, 1000, 26.09.1902", "format_15, 1000, 26.09.1902", "format_16, 1000, 26.09.1902",
			"format_17, 1000, 26.09.1902", "format_22, 1000, 26.09.1902", })
	...
	@ParameterizedTest(name = "Given format number {0} with given value '{1}' should lead to a cell with the same format number and the expected value '{2}'")
	@CsvSource({ "format_19, 0.5, 12:00:00", "format_20, 0.5, 12:00:00", "format_21, 0.5, 12:00:00",
			"format_45, 0.5, 12:00:00", "format_46, 0.5, 12:00:00", "format_47, 0.5, 12:00:00", })
