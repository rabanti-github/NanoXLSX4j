...
public class NumericCellTest {
	...
	@CsvSource({ "0", "16", "-32", "Byte.MIN_VALUE", "Byte.MAX_VALUE", })
	void byteCellTest(String byteString) {
		genericAssertion(byteUtils, byteString, (byte) 8, Byte.MIN_VALUE, Byte.MAX_VALUE, Byte::parseByte,
				Byte::equals);
	}

	@DisplayName("BigDecimal value cell test: Test of the cell values, as well as proper modification")
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "16", "-32", "Integer.MIN_VALUE", "Integer.MAX_VALUE", })
	void bigDecimalCellTest(String byteString) {
		// Note: BigDecimal has no defined MIN and MAX
		genericAssertion(bigDecimalUtils, byteString, BigDecimal.valueOf(8), BigDecimal.valueOf(Integer.MIN_VALUE),
				BigDecimal.valueOf(Integer.MAX_VALUE), BigDecimal::new, BigDecimal::equals);
	}

	@DisplayName("Double value cell test: Test of the cell values, as well as proper modification")
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "1.22", "Double.MIN_VALUE", "Double.MAX_VALUE", })
	void doubleCellTest(String doubleString) {
		genericAssertion(doubleUtils, doubleString, 8d, Double.MIN_VALUE, Double.MAX_VALUE, Double::parseDouble,
				NumericCellTest::compareDouble);
	}

	@DisplayName("Float value cell test: Test of the cell values, as well as proper modification")
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "779.254", "Float.MIN_VALUE", "Float.MAX_VALUE", })
	void floatCellTest(String floatString) {
		genericAssertion(floatUtils, floatString, 8f, Float.MIN_VALUE, Float.MAX_VALUE, Float::parseFloat,
				NumericCellTest::compareFloat);
	}

	@DisplayName("Integer value cell test: Test of the cell values, as well as proper modification")
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "-42", "42", "Integer.MIN_VALUE", "Integer.MAX_VALUE", })
	void integerCellTest(String integerString) {
		genericAssertion(integerUtils, integerString, 8, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer::parseInt,
				Objects::equals);
	}

	@DisplayName("Long value cell test: Test of the cell values, as well as proper modification")
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "-999999999", "55555", "Long.MIN_VALUE", "Long.MAX_VALUE", })
	...
	@ParameterizedTest(name = "Given value {0} should lead to a valid cell")
	@CsvSource({ "0", "127", "-127", "Short.MIN_VALUE", "Short.MAX_VALUE", })
	void shortCellTest(String shortString) {
		genericAssertion(shortUtils, shortString, (short) 8, Short.MIN_VALUE, Short.MAX_VALUE, Short::parseShort,
				Objects::equals);
	}
	...
	@CsvSource({ "42, 42, 0", "42.00001, 42.00001, 0", "100, 24, 1", "0, 127, -1", "-127, 127, -1",
			"-0.00001, 0, -1", })
	...
	@DisplayName("Test of the byte comparison method on cells")
	@ParameterizedTest(name = "Given values of {0} and {1} should lead to a comparison result of {2}")
	@CsvSource({ "42, 42, 0", "100, 24, 1", "0, 127, -1", "-127, 127, -1", })
	...
	@ParameterizedTest(name = "Given values of {0} and {1} should lead to a comparison result of {2}")
	@CsvSource({ "22.223, 22.223, 0", "9999.1, -0.001, 1", "0.23, 18720.0, -1", })
	...
	@ParameterizedTest(name = "Given values of {0} and {1} should lead to a comparison result of {2}")
	@CsvSource({ "42, 42, 0", "9999, -999999, 1", "0, 18720, -1", })
	...
	@ParameterizedTest(name = "Given values of {0} and {1} should lead to a comparison result of {2}")
	@CsvSource({ "42, 42, 0", "9999, -9999, 1", "0, 18720, -1", })
	...
	private <T> void genericAssertion(CellTypeUtils utilsInstance, String valueString, T initialValue, T min, T max,
			Function<String, T> parser, BiFunction<T, T, Boolean> comparer) {
		T value;
	...
	private <T extends Comparable<T>> void assertNumericType(CellTypeUtils utilsInstance, T value1, T value2,
			int expectedResult) {
