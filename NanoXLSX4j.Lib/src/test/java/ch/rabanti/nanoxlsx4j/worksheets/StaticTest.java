...
public class StaticTest {
	...
	@CsvSource({ "test, 0, '', test", "Sheet2, 1, Sheet, Sheet2", ", 0, '', Sheet1", "'', 0, '', Sheet1",
			"a[b, 0, '', a_b", "a]b, 0, '', a_b", "a*b, 0, '', a_b", "a?b, 0, '', a_b", "a/b, 0, '', a_b",
			"a\\b,0, '', a_b", "--------------------------------, 0, '', -------------------------------",
			"Sheet10, 20, Sheet, Sheet21", "*1, 1, _, _2",
			"------------------------------9, 9, ------------------------------, -----------------------------10",
			"'9999999999999999999999999999999', 9, '999999999999999999999999999999', '0'", })
	void sanitizeWorksheetNameTest(String givenName, int numberOfExistingWorksheets, String existingWorksheetPrefix,
			String expectedName) {
