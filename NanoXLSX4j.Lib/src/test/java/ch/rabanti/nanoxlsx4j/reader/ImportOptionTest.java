...
public class ImportOptionTest {
	...
	@CsvSource({ "Date, 'FLOAT', 22.5, 'DOUBLE', 22.5", "Time, 'DOUBLE', 22.5, 'DOUBLE', 22.5", })
	void enforceDateTimesAsNumbersTest2(ImportOptions.ColumnType columnType, String givenType, String givenValue,
			String expectedType, String expectedValue) throws Exception {
	...
	@CsvSource({ "Double, '2021-10-31 12:11:10', 44500.5077546296d", "Double, '18:20:22', 0.764143518518519d",
			"BigDecimal, '2021-10-31 12:11:10', 44500.5077546296d", "BigDecimal, '18:20:22', 0.764143518518519d",
			"Numeric, '2021-10-31 12:11:10', 44500.5077546296d", "Numeric, '18:20:22', 0.764143518518519d", })
	...
	@ParameterizedTest(name = "Given column {1} should lead to a valid import")
	@CsvSource({ "STRING, 'B', Double", "INTEGER, '1', Double", "STRING, 'B', BigDecimal",
	...
	@CsvSource({ "STRING, 'B', 'C'", "INTEGER, '1', '2'", })
	...
	@ParameterizedTest(name = "Given column {1} should lead to a valid import")
	@CsvSource({ "STRING, 'B', Date", "INTEGER, '1', Date", "STRING, 'B', Time", "INTEGER, '1', Time", })
	...
	@CsvSource({ "Bool, 'STRING', '1', 'BOOLEAN', 'true'", "Bool, 'BOOLEAN', 'false', 'BOOLEAN', 'false'",
			"Double, 'STRING','-2.5', 'DOUBLE', '-2.5'", "Double, 'INTEGER','13', 'DOUBLE','13'",
			"Numeric, 'STRING', '12.5', 'FLOAT', '12.5'", "Numeric, 'INTEGER','13', 'INTEGER', '13'",
			"String, 'FLOAT','16.5','STRING', '16.5'", "String, 'BOOLEAN','true','STRING', 'true'", })
	void enforcingColumnStartRowTest(ImportOptions.ColumnType columnType, String givenType, String givenSourceValue,
			String expectedType, String expectedSourceValue) throws Exception {
	...
	@CsvSource({ "AllNumbersToBigDecimal, BigDecimal, '7', '23', 1.1, 'BIGDECIMAL'",
	...
	void importEnforceOverlappingTest(ImportOptions.GlobalType globalType, ImportOptions.ColumnType columnType,
			Object givenA2Value, Object givenB1Value, Object givenB2Value, String expectedType) throws Exception {
		Map<String, Object> cells = new HashMap<>();
		Map<String, Object> expectedCells = new HashMap<>();
		cells.put("A1", "test");
	...
	@ParameterizedTest(name = "Given global type {0} and column type {1} should lead to a valid, enforced import")
	@CsvSource({ "BigDecimal, AllNumbersToBigDecimal, '7', '23', 1.1, 'BIGDECIMAL'",
	...
	void importEnforceOverruleTest(ImportOptions.ColumnType columnType, ImportOptions.GlobalType globalType,
			Object givenA2Value, Object givenB1Value, Object givenB2Value, String expectedType) throws Exception {
		Map<String, Object> cells = new HashMap<>();
		Map<String, Object> expectedCells = new HashMap<>();
		cells.put("A1", "test");
	...
	@ParameterizedTest(name = "Given type {0} should lead to a valid import")
	@CsvSource({ "Date, 'yyyy-MM-dd HH:mm:ss', '2021-08-12 12:11:10', '2021-08-12 12:11:10'",
			"Date, 'dd.MM.yyyy HH:mm:ss', '12.08.2021 12:11:10', '2021-08-12 12:11:10'",
			"Date, 'dd/MM/yyyy', '12/08/2021', '2021-08-12 00:00:00'", "Time, 'HH:mm:ss', '18:11:10', '18:11:10'",
			"Time, 'HH', '12', '12:00:00'", })
	...
	@CsvSource({ "Time, '55.81.202x'", "Date, '2022-18-22 15:6x:00'", "Time, '10000-01-01 00:00:00'",
			"Date, '10000-01-01 00:00:00'", "Time, '1800-01-01 00:00:00'", "Time, '-10:00:00'", })
	...
	private static <T, D> void assertValues(Map<String, T> givenCells, ImportOptions importOptions,
			BiConsumer<Object, Object> assertionAction) throws Exception {
		assertValues(givenCells, importOptions, assertionAction, null);
	}

	private static <T, D> void assertValues(Map<String, T> givenCells, ImportOptions importOptions,
			BiConsumer<Object, Object> assertionAction, Map<String, D> expectedCells) throws Exception {
