...
public class HelperTest {
	...
	@CsvSource({ "01.01.1900 00:00:00, 1", "02.01.1900 12:35:20, 2.5245370370370401", "27.02.1900 00:00:00, 58",
			"28.02.1900 00:00:00, 59", "28.02.1900 12:30:32, 59.521203703703705", "01.03.1900 00:00:00, 61",
			"01.03.1900 08:08:11, 61.339016203703707", "20.05.1960 22:11:05, 22056.924363425926",
			"01.01.2021 00:00:00, 44197", "12.12.5870 11:30:12, 1450360.47930556", })
	...
	@CsvSource({ "01.01.0001 00:00:00", "18.05.0712 11:15:02", "31.12.1899 23:59:59", "01.01.10000 00:00:00", })
	...
	@CsvSource({ "00:00:00, 0.0", "12:00:00, 0.5", "23:59:59,  0.999988425925926", "13:11:10, 0.549421296296296",
			"18:00:00, 0.75", })
	...
	@CsvSource({ "0.5, 0.85546875", "1, 1.7109375", "10, 10.7109375", "15, 15.7109375", "60, 60.7109375",
			"254, 254.7109375", "255, 255.7109375", "0, 0f", })
	...
	@CsvSource({ "0.1, 0f", "0.5, 0.75", "1, 0.75", "10, 9.75", "15, 15", "409, 408.75", "409.5, 409.5", "0, 0f", })
	...
	@CsvSource({ "0.1f, 390f", "1f, 390f", "18.5, 2415f", "32f, 3825f", "255, 27240f", "256, 27345f", "1000, 105465f",
			"0, 390f", "-1, 390f", "-10, 390f", })
	...
	@CsvSource({ "0.1f, 302f", "0.5f, 310f", "1f, 320f", "15f, 600f", "409.5, 8490f", "500, 10300f", "0, 300f",
			"-1, 300f", "-10, 300f", })
	...
	@ParameterizedTest(name = "Given value {0} should lead to the height {1}")
	@CsvSource({ "301f, 0.05f", "320f, 1f", "600f, 15f", "310f, 0.5f", "8490f, 409.5", "10300f, 500", "300f, 0",
			"299.9, 0", "-10, 0", })
	...
	@ParameterizedTest(name = "Given value {0} should lead to the height {1}")
	@CsvSource({ "390f, 0f", "2415f, 18.5f", "1680f, 11.5f", "3825f, 31.9286f", "27240f, 254.9286f",
			"27345f, 255.9286f", "105465f, 999.9286f", })
	...
	@CsvSource({ "1, '01.01.1900 00:00:00'", "2.5245370370370401, '02.01.1900 12:35:20'", "58, '27.02.1900 00:00:00'",
			"59, '28.02.1900 00:00:00'", "59.521203703703705, '28.02.1900 12:30:32'", "61, '01.03.1900 00:00:00'",
			"61.339016203703707, '01.03.1900 08:08:11'", "22056.924363425926, '20.05.1960 22:11:05'",
			"44197, '01.01.2021 00:00:00'", "1450360.47930556, '12.12.5870 11:30:12'", })
	...
	@CsvSource({ "'12:13:14', 'HH:mm:ss', 'en-US', 'PT12H13M14S'", "'00-00-00', 'HH-mm-ss', 'CA-fr', 'PT0S'",
			"'59/59/23', 'mm/ss/HH', 'en-US', 'PT23H59M59S'", "'10:11', 'HH:mm', 'de-DE', 'PT10H11M'",
			"'09:10:12 PM', 'hh:mm:ss a', 'en-US', 'PT21H10M12S'", "'09:10:12 AM', 'hh:mm:ss a', 'en-US', 'PT9H10M12S'",
			"'09:10:12p.m.', 'hh:mm:ssa', 'ca-FR', 'PT21H10M12S'", "'01.01.2022', 'dd.MM.yyyy', 'en-US', 'PT0S'", // Not
																													// properly
																													// formatted
																													// to
																													// get
																													...
																													// of
																													// days
			"'01.01.2022 22-11-05', 'dd.MM.yyyy HH-mm-ss', 'ca-FR', 'PT22H11M5S'", // Not properly formatted to get the
																					// number of days
	...
	@CsvSource({ "NULL, '', 'HH:mm:ss'", "STRING, '?', 'HH:mm:ss'", "STRING, '', 'HH:mm:ss'",
			"STRING, '12-10-09', 'HH:mm:ss'", "STRING, '12-10-09 1', 'HH-mm-ss'", "STRING, '12-10-09', 'n HH-mm-ss'",
			"STRING, '-1 12-10-09', 'n HH-mm-ss'", "STRING, 'x 12-10-09', 'n HH-mm-ss'",
	...
	@CsvSource({ "0, 0, 0, 'PT0S'", "12, 10, 9, 'PT12H10M9S'", "23, 59, 59, 'PT23H59M59S'", })
	...
	@CsvSource({ "0, 0, 0, 0, 'PT0S'", "0, 12, 10, 9, 'PT12H10M9S'", "0, 23, 59, 59, 'PT23H59M59S'",
			"1, 0, 0, 0, 'PT24H'", "2, 3, 4, 5, 'PT51H4M5S'", })
	...
	@CsvSource({ "-1, 0, 0", "10, -1, 0", "1, 0, -5", "25, 1, 0", "10, 62, 30", "0, 12, 120", })
	...
	@CsvSource({ "-1, 0, 0, 0", "-10, 10, -1, 0", "5, 1, 0, -5", "10, 25, 1, 0", "0, 10, 62, 30", "-1, 0, 12, 120",
			"2958466, 0, 0, 0", "2958465, 10, -1, 0", "2958465, 1, 0, -5", "2958465, 25, 1, 0", "2958465, 10, 62, 30",
			"2958465, 0, 12, 120", "2958466, 1 , 1, 1", })
	...
	@CsvSource({ "'x','CEBA'", "'Test@1-2,3!','F767'", "' ','CE0A'", "'',''", ",''", })
