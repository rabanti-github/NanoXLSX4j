...
public class Fill extends AbstractStyle {
    ...
    /**
     * Gets the foreground color of the fill. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Sets the foreground color of the fill. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Gets the Background color of the fill. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
    ...
    /**
     * Sets the background color of the fill. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF
     *
