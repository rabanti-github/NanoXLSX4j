...
public class StyleRepository {
     ...
     * @return Reference from the repository. If the style to add already existed, the existing object is returned, otherwise the newly added one
     */
     ...
     *
     * @apiNote Do not use this maintenance method while writing data on a worksheet or workbook. It will lead to invalid style data or even exceptions.<br/>
