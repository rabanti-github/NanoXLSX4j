...
public @interface AppendAnnotation {
    ...
    /**
     * Indicates whether the property annotated with the attribute is a nested property. Nested properties are ignored
     * during the copying of properties but can be broken down to its sub-properties
     *
