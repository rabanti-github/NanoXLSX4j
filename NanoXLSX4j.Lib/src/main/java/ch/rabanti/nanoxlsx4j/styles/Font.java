...
public class Font extends AbstractStyle {
    ...
    /**
     * Sets the color code of the font color. The value is expressed as hex string with the format AARRGGBB. AA (Alpha)
     * is usually FF.<br> To omit the color, an empty string can be set. Empty is also default.
     *
