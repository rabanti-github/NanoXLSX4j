...
public final class BasicStyles {
    ...
    /**
     * Gets a style with a user defined Font (Font size 11)<br> Note: The Font name as well as the availability of bold
     * and italic on the Font cannot be validated by PicoXLSX4j. The generated file may be corrupt or rendered with a
     * fall-back Font in case of an error
     *
    ...
    /**
     * Gets a style with a user defined Font<br> Note: The Font name as well as the availability of bold and italic on
     * the Font cannot be validated by PicoXLSX4j. The generated file may be corrupt or rendered with a fall-back Font
     * in case of an error
     *
     * @param fontName Name of the Font
