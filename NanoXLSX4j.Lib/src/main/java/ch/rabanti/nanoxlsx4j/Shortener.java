...
/**
 * Class to provide access to the current worksheet with a shortened syntax<br> Note: The WS object can be null if the
 * workbook was created without a worksheet. The object will be available as soon as the current worksheet is defined
 *
...
public class Shortener {
     ...
     * @throws WorksheetException Throws a WorksheetException if no worksheet was defined
     * @throws RangeException     Throws a RangeException if the row number is below 0
     * @apiNote Values can be also negative. However, this is the equivalent of the function {@link #down(int)}}
     */
     ...
     * @throws WorksheetException Throws a WorksheetException if no worksheet was defined
     * @throws RangeException     Throws a RangeException if the column number is below 0
     * @apiNote Values can be also negative. However, this is the equivalent of the function {@link #right(int)}}
     */
