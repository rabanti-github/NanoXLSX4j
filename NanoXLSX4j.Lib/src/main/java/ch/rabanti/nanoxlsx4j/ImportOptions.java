...
public class ImportOptions {
    ...
    /**
     * Global conversion types to enforce during the import. All types other than {@link GlobalType#Default} will
     * override defined {@link ColumnType}s
     */
    public enum GlobalType {
        ...
        /**
         * All numbers are cast to integers. Floating point numbers will be rounded (commercial rounding) to the nearest
         * integer
         */
        AllNumbersToInt,
        /**
    ...
    public enum ColumnType {
        ...
        BigDecimal,
        /**
         * Cells are tried to be imported as dates (Date). If values are provided as Strings, the String defined with
         * {@link ImportOptions#setDateFormat(java.lang.String)} will be used as parsing pattern
         */
        Date,
        /**
     ...
     *
     * @return If true, date or time values (default format number 14 or 21) will be interpreted as numeric values
     * globally. This option overrules possible column options, defined by {@link #addEnforcedColumn(int, ColumnType)}
     */
    ...
    /**
     * gets the row number (zero-based) where enforcing rules are started to be applied. This is, for instance, to
     * prevent enforcing in a header row
     *
     * @return Row number
     */
     ...
     *
     * @param enforceDateTimesAsNumbers If true, date or time values (default format number 14 or 21) will be
    ...
    /**
     * Sets the row number (zero-based) where enforcing rules are started to be applied. This is, for instance, to
     * prevent enforcing types in a header row. Any enforcing rule is skipped until this row number is reached
     *
    ...
    /**
     * Gets whether phonetic characters (like ruby characters / Furigana / Zhuyin fuhao) in strings are added in
     * brackets after the transcribed symbols. By default, phonetic characters are removed from strings.
     *
    ...
    /**
     * Sets whether phonetic characters (like ruby characters / Furigana / Zhuyin fuhao) in strings are added in
     * brackets after the transcribed symbols. By default, phonetic characters are removed from strings.
     *
     ...
     *
     * @return If true, empty cells will be interpreted as type of string with an empty value. If false, the type will
     * be Empty and the value null
     */
     ...
     *
     * @param enforceEmptyValuesAsString If true, empty cells will be interpreted as type of string with an empty value.
    ...
    /**
     * Sets the global strategy to handle cell values. The default will not enforce any casting, beside defined values
     * of {@link ImportOptions#setEnforceDateTimesAsNumbers(boolean)},
     * {@link ImportOptions#setEnforceEmptyValuesAsString(boolean)} and
     * {@link ImportOptions#addEnforcedColumn(int, ColumnType)}
     *
    ...
    /**
     * Gets the Locale instance, used to parse Duration objects from strings. If null, parsing will be tried with 'best
     * effort'.
     *
    ...
    /**
     * Sets the Locale instance, used to parse Duration objects from strings. If null, parsing will be tried with 'best
     * effort'.
     *
    ...
    /**
     * Sets the format if LocalTime values are cast to Strings.<br> Note that the parameter 'n' in a pattern is used to
     * parse the number of days since 1900-01-01
     *
