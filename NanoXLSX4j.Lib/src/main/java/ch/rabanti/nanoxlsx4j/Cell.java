...
// ### G E T T E R S  &  S E T T E R S ###
     ...
     *
     * @return Address type
     * @apiNote The type has no influence on the behavior of the cell, though. It is preserved to avoid losing information on the address object of the cell
     */
...
// ### M E T H O D S ###
     ...
     * @implNote Note that this method only compares the row and column numbers, since the values or styles may completely different types,
     * and therefore hard to compare at all.<br/> The Equals() method considers values and style, though.
     */
    @Override
