...
public class Address implements Comparable<Address> {
    ...
    /**
     * Compares two addresses whether they are equal. The address type id neglected, only the row and column is
     * considered
     *
    ...
    /**
     * Compares two addresses and returns whether the passed one is bigger or not. Bigger means: Higher column number
     * and / or higher row number
     *
