...
public class Helper {
    ...
    /**
     * Method to calculate the OA date (OLE automation) of the passed date.<br> OA Date format starts at January 1st
     * 1900 (actually 00.01.1900). Dates beyond this date cannot be handled by Excel under normal circumstances and will
     * throw a FormatException.<br> Excel assumes wrongly that the year 1900 is a leap year. There is a gap of 1.0
     * between 1900-02-28 and 1900-03-01. This method corrects all dates from the first valid date (1900-01-01) to
     * 1900-03-01. However, Excel displays the minimum valid date as 1900-01-00, although 0 is not a valid description
     * for a day of month.<br> In conformance to the OAdate specifications, the maximum valid date is 9999-12-31
     * 23:59:59 (plus 999 milliseconds).<br> See also: <a href=
     * "https://docs.microsoft.com/en-us/dotnet/api/system.datetime.tooadate?view=netcore-3.1"><br>
     * https://docs.microsoft.com/en-us/dotnet/api/system.datetime.tooadate?view=netcore-3.1</a><br> See also: <a href=
    ...
    /**
     * Method to convert a duration into the internal Excel time format (OAdate without days).<br> The time is
     * represented by a OAdate without the date component but a possible number of total days
     *
     ...
     * @implNote Numbers that represents dates before 1900-03-01 (number of days since 1900-01-01 = 60) are
     * automatically modified. Until 1900-03-01 is 1.0 added to the number to get the same date, as displayed in Excel.
     * The reason for this is a bug in Excel. See also: <a href=
     * "https://docs.microsoft.com/en-us/office/troubleshoot/excel/wrongly-assumes-1900-is-leap-year"><br>
     * https://docs.microsoft.com/en-us/office/troubleshoot/excel/wrongly-assumes-1900-is-leap-year</a>
     */
    ...
    /**
     * Method to parse a {@link Duration} object from a string and a pattern that is allied to a
     ...
     * of days, the pattern 'n' is used. This deviates from the actual definition of 'n' which would be nanoseconds of
     * the second. date-related patterns like 'dd', 'MM' or 'yyyy' are not supported yet for time parsing
     */
     ...
     * @apiNote Note that the formatter may consider locales. Parsing may fail e.g. with "AM/PM" when not on
     * {@link Locale#US}. Supported formatting tokens are all time-related patterns like 'HH', 'mm', 'ss'. To represent
     * the number of days, the pattern 'n' is used. This deviates from the actual definition of 'n' which would be
     * nanoseconds of the second. date-related patterns like 'dd', 'MM' or 'yyyy' are not supported yet for time
     * parsing
     */
     ...
     *                       {@link Helper#SPLIT_HEIGHT_POINT_OFFSET}
     * @return Actual pane height
     * @apiNote Depending on the initial height, the result value of {@link Helper#getInternalPaneSplitHeight(float)}
     ...
     *                      {@link Helper#SPLIT_WIDTH_POINT_OFFSET}
     ...
     * {@link Helper#getInternalPaneSplitWidth(float, float, float)} may not lead back to the initial value, since
    ...
    /**
     * Method to generate an Excel internal password hash to protect workbooks or worksheets<br> This method is derived
     * from the c++ implementation by Kohei Yoshida (<a href=
     ...
     * outside from PicoXLSX4j. This is only a minor security feature. Use a proper cryptography method instead.
     *
     ...
     * @return Duration object
     * @throws FormatException thrown if one of the components is invalid (e.g. negative), or if the number of days
     *                         exceeds the year 9999
     */
