...
public class StyleReaderContainer {
    ...
    /**
     * Returns a whole style by its index. It also returns information about the type of the style, regarding dates or
     * times
     *
     * @param index Index of the style
     * @return Style object or null if the component could not be retrieved
    ...
    /**
     * Gets the next internal id of a cell XF component.<br> The method is currently not used but prepared for usage
     * when the style reader is fully implemented
     *
    ...
    /**
     * Gets the next internal id of a border component.<br> The method is currently not used but prepared for usage when
     * the style reader is fully implemented
     *
     * @return Next id of the component type (collected in this class)
     */
    ...
    /**
     * Gets the next internal id of a fill component.<br> The method is currently not used but prepared for usage when
     * the style reader is fully implemented
     *
     * @return Next id of the component type (collected in this class)
     */
    ...
    /**
     * Gets the next internal id of a font component.<br> The method is currently not used but prepared for usage when
     * the style reader is fully implemented
     *
     * @return Next id of the component type (collected in this class)
     */
    ...
    /**
     * Internal method to retrieve style components.<br> Note: CellXF is not handled, since retrieved in the style
