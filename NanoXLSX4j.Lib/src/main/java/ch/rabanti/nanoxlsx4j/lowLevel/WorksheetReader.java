...
public class WorksheetReader {
	 ...
	 *
	 * @param styleReaderContainer
	 *            Resolved styles from the style reader
	 */
	 ...
	 *
	 * @param xmlDocument
	 *            XML document of the current worksheet
	 */
	 ...
	 *
	 * @param raw
	 *            Raw value that can be either an ID of a shared string or an actual
	 *            string value
	 ...
	 *            String to parse
	 * @param options
	 *            Import options to take the parsing patterns of
	...
	static class RowDefinition {
		 ...
		 *
		 * @param height
		 *            Row height. If null, no specific height was defined (remains
		 *            default)
		 */
		 ...
		 *            Row map
		 * @param rowNumber
		 *            Row number as string (directly resolved from the corresponding XML
		 *            attribute)
		 * @param heightProperty
		 *            Row height as string (directly resolved from the corresponding XML
		 *            attribute)
		 * @param hiddenProperty
		 *            Hidden definition as string (directly resolved from the
