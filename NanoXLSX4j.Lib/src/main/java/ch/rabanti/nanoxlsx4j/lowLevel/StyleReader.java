...
public class StyleReader {
    ...
    /**
     * Gets the XML attribute from a child node of the passed XML node by its name and the name of the child node. This
     * method simplifies the process of gathering one single child node attribute
     *
